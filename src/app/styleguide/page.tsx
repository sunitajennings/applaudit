      ...
      <PageTransition className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mb-16">
          <div className="mb-6">
            ...
            <p className="text-base text-muted-foreground">Logos and such.</p>
          </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <Card variant="light">
                        <CardHeader>
                          ...
                          <CardDescription>
                            This is a light card variant
                          </CardDescription>
                        </CardHeader>
                        <CardContent>
                          <p className="text-sm text-foreground">
                            Card content goes here. This demonstrates the light
                            styling.
                          </p>
                        </CardContent>
                      </Card>
                      ...
                      <Card variant="dark">
                        <CardHeader>
                          ...
                          <CardDescription>
                            This is a dark card variant
                          </CardDescription>
                        </CardHeader>
                        <CardContent>
                          <p className="text-sm text-foreground">
                            Card content goes here. This demonstrates the dark
                            styling.
                          </p>
                        </CardContent>
                      </Card>
                  ...
                  <div>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <p className="text-sm text-foreground">
                          Card content goes here. The footer can contain actions
                  ...
                  <div>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <p className="text-sm text-foreground">
                          Card content goes here. The action button appears in
